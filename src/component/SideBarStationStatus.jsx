...
import StationStatusNav from "./StationStatus/StationStatusNav";
...
const SidebarLatest = () => {
  ...
  return (
    <div className="d-flex">
      ...
      <div className="main-content" style={{ marginLeft: "80px", width: "100%" }}>
        
        <NavBar />

        
        <div className="station-status-nav p-3">
          <StationStatusNav />
        </div>
      </div>
    </div>
